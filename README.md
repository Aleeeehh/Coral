...
Here, you will find all the code involved, from the developed firmware for the ESP32-S3, as well all the python notebooks used for the experiments. You can also find the complete [thesis PDF](Bachelor's%20Thesis/Thesis.pdf) and the [presentation slides](Bachelor's%20Thesis/Presentation.pdf)in Italian.
